<?php 
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$qry = "INSERT INTO `subject` (`Sub_Name`) VALUES ('$subject')";
		
		$run = mysqli_query($con,$qry);
		if($run){
			$submit_msg = '<div class="alert alert-success alert-dismissible fade show" role="alert">
						<strong><i><i class="fas fa-check"></i> Subject added successful!</i></strong>
			...
			$submit_msg = '<div class="alert alert-danger alert-dismissible fade show" role="alert">
						<strong><i class="fas fa-times"></i> Subject added fail!</i></strong>
						<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
						</button>
						</div>';
			...
			<div class="row  border rounded border-info mt-3 mb-3"> 
				...
				<div class="col-md-12">
					<div class="mt-3 mb-3">
						...
						<div class="col-md-6">
							<form class="was-validated" action="subject.php" method="post" enctype="multipart/form-data">
